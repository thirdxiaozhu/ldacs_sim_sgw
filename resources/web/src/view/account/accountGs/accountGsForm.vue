    ...
    <div class="gva-form-box">
      <el-form :model="formData" ref="elFormRef" label-position="right" :rules="rule" label-width="80px">
        <el-form-item label="地面站SAC:" prop="gs_sac">
          <el-input v-model.number="formData.gs_sac" :clearable="false" placeholder="请输入" />
       </el-form-item>
        <el-form-item label="北纬:" prop="latitude_n">
          <el-input-number v-model="formData.latitude_n" :precision="2" :clearable="true"></el-input-number>
       </el-form-item>
        <el-form-item label="东经:" prop="longtitude_e">
          <el-input-number v-model="formData.longtitude_e" :precision="2" :clearable="true"></el-input-number>
       </el-form-item>
        <el-form-item>
