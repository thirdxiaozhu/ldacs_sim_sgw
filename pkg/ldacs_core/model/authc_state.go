...
type AuthcState struct {
	global.PREFIX_MODEL
	AuthcAsSac     uint64               `json:"authc_as_sac" form:"authc_as_sac" gorm:"column:authc_as_sac;comment:;"`    //认证飞机站
	AuthcGsSac     uint64               `json:"authc_gs_sac" form:"authc_gs_sac" gorm:"column:authc_gs_sac;comment:;"`    //当前地面站
	AuthcGscSac    uint64               `json:"authc_gsc_sac" form:"authc_gsc_sac" gorm:"column:authc_gsc_sac;comment:;"` //当前地面控制站
	AuthcState     global.AuthStateKind `json:"authc_state" form:"authc_state" gorm:"column:authc_state;comment:;"`       //认证状态
