...
func Routers() *gin.Engine {
	...
	// 设置为发布模式
	if f_global.GVA_CONFIG.System.Env == "public" {
	...
	Router.StaticFS(f_global.GVA_CONFIG.Local.StorePath, http.Dir(f_global.GVA_CONFIG.Local.StorePath)) // 为用户头像和文件提供静态地址
	...
	PublicGroup := Router.Group(f_global.GVA_CONFIG.System.RouterPrefix)
	{
		// 健康监测
	...
	PrivateGroup := Router.Group(f_global.GVA_CONFIG.System.RouterPrefix)
	...
	}
	{
		...
		ldacs_sgw_forwardRouter.InitAccountAsRouter(PrivateGroup)
